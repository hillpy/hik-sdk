...
namespace Hillpy\HikSDK\InfovisionForesight;

use Hillpy\HikSDK\BaseTrait;
use Hillpy\HikSDK\CacheKey;
use Hillpy\HikSDK\InfovisionForesight\Interfaces\AuthInterface;
use Hillpy\HikSDK\InfovisionForesight\Interfaces\CameraInterface;
use Hillpy\HikSDK\InfovisionForesight\Traits\AuthTrait;
use Hillpy\HikSDK\InfovisionForesight\Traits\CameraTrait;
use Hillpy\HikSDK\Libraries\Cache\Cache;
use Hillpy\HikSDK\Libraries\Common\Common;

class IFORE implements
    AuthInterface,
    CameraInterface
{
    use AuthTrait,
    ...
    private $options = [
        ...
        'app_secret' => '',
        'cache_driver' => 'file',
        'cache_prefix' => 'hik_sdk_ifore_',
        'cache_key' => 'hik_sdk_infovisionforesight',
        'cache_expire' => 3600 * 24 * 7,
        'cache_file_base_path' => '',
        'cache_file_path' => '/HikSDKCache/IFORE',
        'cache_file_ext' => 'php',
    ];
    ...
    private function init($options = [])
    {
        ...
        // 解析缓存key的通用前缀
        $this->cacheKeyPrefix = Common::parseStr(CacheKey::$prefix, ['platform' => 'ifore', 'app_key' => $this->options['app_key']]);
        // 获取accessToken
